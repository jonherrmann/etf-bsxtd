 ...
 */
public class LegacyDatabasePartitioner implements LegacyDatabaseVisitor {
    ...
    public LegacyDatabasePartitioner(long maxDbSizeSizePerChunk, final Logger logger,
