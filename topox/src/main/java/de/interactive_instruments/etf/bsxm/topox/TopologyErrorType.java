...
enum TopologyErrorType {
    ...
    /**
     * Topology-Edge that is part of the boundary and is not enclosed by a boundary object
     *
     * Outputs: - X, Y for the point of failure - IS for the existing object that is on the edge
     */
